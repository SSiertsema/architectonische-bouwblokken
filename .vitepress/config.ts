        ...
        items: [
          {
            ...
            collapsed: true,
            items: [
              { text: 'Uitwerking — overzicht', link: '/group-a-identity-access/uitwerking/' },
              {
                text: 'Casussen',
                collapsed: true,
                items: [
                  { text: 'Casus 1 — Interne beheertool', link: '/group-a-identity-access/uitwerking/casus-1-interne-beheertool' },
                  { text: 'Casus 2 — B2B SaaS multi-IdP', link: '/group-a-identity-access/uitwerking/casus-2-b2b-saas-multi-idp' },
                  { text: 'Casus 3 — Publieksapplicatie burgers', link: '/group-a-identity-access/uitwerking/casus-3-publieksapplicatie-burgers' },
                  { text: 'Casus 4 — Overheidsdienst bedrijven', link: '/group-a-identity-access/uitwerking/casus-4-overheidsdienst-bedrijven' },
                  { text: 'Casus 5 — Consumentenproduct (CIAM)', link: '/group-a-identity-access/uitwerking/casus-5-consumentenproduct-ciam' },
                ],
              },
              {
              ...
              },
              {
                ...
                collapsed: true,
                items: [
                  { text: 'Sanne de Beleidsmedewerker', link: '/group-a-identity-access/uitwerking/personas/sanne-beleidsmedewerker' },
                ],
              },
              {
                ...
                collapsed: true,
                items: [
                  { text: 'Gemeente Meerwijde', link: '/group-a-identity-access/uitwerking/organisatieprofielen/gemeente-meerwijde' },
                ],
              },
            ],
          },
